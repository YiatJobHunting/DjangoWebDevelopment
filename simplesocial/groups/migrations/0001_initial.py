# Generated by Django 2.2.1 on 2019-10-07 18:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desprition', models.TextField(blank=True, default='')),
                ('desprition_html', models.TextField(blank=True, default='', editable=False)),
            ],
            options={
                'ordering': ['name'],
            },
